...
export const Steps: React.FC<StepsProps> = ({ t }) => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
      {t.steps.map((step, i) => (
        <div key={i} className="bg-white p-6 rounded-xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
          ...
          <h3 className="font-semibold text-slate-800 mb-2">{i + 1}. {step.title}</h3>
